...
use Flexpik\FilamentStudio\Mcp\Actions\Records\CreateRecord;
...
class CreateRecordTool extends Tool
{
    ...
    protected string $name = 'studio_create_record';

    protected string $description = 'Create a record. data is a {field: value} map. Validation comes from the collection field definitions.';
    ...
    public function handle(Request $request): Response
    {
        try {
            ...
            $this->requireCollectionAction($slug, ApiAction::Store);

            $record = (new CreateRecord)($request->all(), $apiKey->tenant_id);
